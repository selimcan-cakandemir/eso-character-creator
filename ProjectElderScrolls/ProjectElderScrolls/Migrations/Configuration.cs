namespace ProjectElderScrolls.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ProjectElderScrolls.Models.ProjectDbContext>
    {
        ...
        protected override void Seed(ProjectElderScrolls.Models.ProjectDbContext context)
        {
            #region Classes
